...
public class SoundManager implements ISoundManager {
     ...
     */
    public void playBulletSound(IBattleBulletProxy bp, float battleFiedsWidth) {
        float pan = 0;
     ...
     */
    public void playRobotSound(IBattleRobotProxy robotView) {
        float pan = 0;
     ...
     */
    private float calcBulletVolume(IBattleBulletProxy bp) {
