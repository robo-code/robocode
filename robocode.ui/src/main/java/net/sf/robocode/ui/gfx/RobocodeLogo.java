...
public class RobocodeLogo {
	...
	private void drawTanks(Graphics2D g) {
		...
		RenderImage explRenderImage1 = new RenderImage(
				ImageUtil.getImage("/net/sf/robocode/ui/images/standard/explosion/explosion2-24.png"));
		...
		RenderImage explRenderImage2 = new RenderImage(
				ImageUtil.getImage("/net/sf/robocode/ui/images/standard/explosion/explosion1-8.png"));
		...
		RenderImage explRenderImage3 = new RenderImage(
				ImageUtil.getImage("/net/sf/robocode/ui/images/standard/explosion/explosion1-1.png"));
		...
		RenderImage explRenderImage4 = new RenderImage(
				ImageUtil.getImage("/net/sf/robocode/ui/images/standard/explosion/explosion1-6.png"));
	...
	private void drawRobot(Graphics2D g, int x, int y, float bodyAngle, float gunAngle, float radarAngle, Color color) {
		...
		RenderImage bodyRenderImage = new RenderImage(
				ImageUtil.createColouredRobotImage(ImageUtil.getImage("/net/sf/robocode/ui/images/standard/body.png"), color));
		...
		RenderImage gunRenderImage = new RenderImage(
				ImageUtil.createColouredRobotImage(ImageUtil.getImage("/net/sf/robocode/ui/images/standard/turret.png"), color));
		...
		RenderImage radarRenderImage = new RenderImage(
				ImageUtil.createColouredRobotImage(ImageUtil.getImage("/net/sf/robocode/ui/images/standard/radar.png"), color));
