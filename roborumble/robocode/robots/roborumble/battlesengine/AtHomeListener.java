...
public class AtHomeListener implements RobocodeListener 
{
	...
	public AtHomeListener(Coordinator c) { coord = c; }

	public void battleComplete(BattleSpecification battlespecification, RobotResults[] robotresultses) { if (coord != null) coord.put(); }
