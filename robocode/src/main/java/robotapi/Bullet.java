...
/**
 * Represents a bullet. This is returned from {@link robotapi.Robot#fireBullet(double)}
 * and {@link robotapi.AdvancedRobot#setFireBullet(double)}, and all the bullet-related
 * events.
 *
 * @author Mathew A. Nelson (original)
 * @see robotapi.Robot#fireBullet(double)
 * @see robotapi.AdvancedRobot#setFireBullet(double)
 * @see robotapi.BulletHitEvent
 * @see robotapi.BulletMissedEvent
