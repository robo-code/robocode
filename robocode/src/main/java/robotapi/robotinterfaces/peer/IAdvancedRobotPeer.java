 ...
 *     - Javadocs
 *******************************************************************************/
package robotapi.robotinterfaces.peer;
 ...
 * {@link robotapi.AdvancedRobot} and {@link robotapi.TeamRobot}.
 * <p/>
...
public interface IAdvancedRobotPeer extends IStandardRobotPeer {
	 ...
	 * @see robotapi.robotinterfaces.IBasicEvents#onScannedRobot(ScannedRobotEvent)
	 ...
	 * 	 {@link robotapi.CustomEvent}:           80
	 * 	 {@link MessageEvent}:          75
	 * 	 {@link RobotDeathEvent}:       70
	 * 	 {@link robotapi.BulletMissedEvent}:     60
	 * 	 {@link BulletHitBulletEvent}:  55
	 * 	 {@link robotapi.BulletHitEvent}:        50
	 * 	 {@link HitByBulletEvent}:      40
	 * 	 {@link HitWallEvent}:          30
	 * 	 {@link robotapi.HitRobotEvent}:         20
	 * 	 {@link ScannedRobotEvent}:     10
	 * 	 {@link robotapi.DeathEvent}:            -1 (reserved)
	 * </pre>
	 * <p/>
	 ...
	 * @see robotapi.BulletHitBulletEvent
	 * @see BulletMissedEvent
	 * @see HitByBulletEvent
	 * @see robotapi.HitRobotEvent
	 * @see HitWallEvent
	 * @see SkippedTurnEvent
	 * @see robotapi.CustomEvent
	 * @see robotapi.DeathEvent
	 * @see WinEvent
	 * @see MessageEvent
	 * @see robotapi.robotinterfaces.IBasicEvents#onScannedRobot(ScannedRobotEvent)
	 *      onScannedRobot(ScannedRobotEvent)
	 * @see robotapi.robotinterfaces.IBasicEvents#onBulletHit(robotapi.BulletHitEvent)
	 *      onBulletHit(BulletHitEvent)
	 * @see robotapi.robotinterfaces.IBasicEvents#onBulletHitBullet(robotapi.BulletHitBulletEvent)
	 *      onBulletHitBullet(BulletHitBulletEvent)
	 * @see robotapi.robotinterfaces.IBasicEvents#onBulletMissed(robotapi.BulletMissedEvent)
	 *      onBulletMissed(BulletMissedEvent)
	 * @see robotapi.robotinterfaces.IBasicEvents#onHitByBullet(HitByBulletEvent)
	 *      onHitByBullet(HitByBulletEvent)
	 * @see robotapi.robotinterfaces.IBasicEvents#onHitRobot(HitRobotEvent)
	 *      onHitRobot(HitRobotEvent)
	 * @see robotapi.robotinterfaces.IBasicEvents#onHitWall(HitWallEvent)
	 *      onHitWall(HitWallEvent)
	 * @see robotapi.robotinterfaces.IBasicEvents#onDeath(robotapi.DeathEvent)
	 *      onDeath(DeathEvent)
	 * @see robotapi.robotinterfaces.IBasicEvents#onRobotDeath(RobotDeathEvent)
	 *      onRobotDeath(DeathEvent)
	 * @see robotapi.robotinterfaces.IBasicEvents#onWin(WinEvent)
	 *      onWin(WinEvent)
	 * @see robotapi.robotinterfaces.IAdvancedEvents#onSkippedTurn(SkippedTurnEvent)
	 *      onSkippedTurn(SkippedTurnEvent)
	 * @see robotapi.robotinterfaces.IAdvancedEvents#onCustomEvent(robotapi.CustomEvent)
	 *      onCustomEvent(CustomEvent)
	 * @see robotapi.robotinterfaces.ITeamEvents#onMessageReceived(MessageEvent)
	 */
	 ...
	 *         robot's queue
	 * @see robotapi.robotinterfaces.IBasicEvents#onBulletHitBullet(BulletHitBulletEvent)
	 *      onBulletHitBullet(BulletHitBulletEvent)
	 * @see robotapi.BulletHitBulletEvent
	 * @see #getAllEvents()
	 */
	 ...
	 *         queue
	 * @see robotapi.robotinterfaces.IBasicEvents#onHitRobot(robotapi.HitRobotEvent)
	 *      onHitRobot(HitRobotEvent)
	 * @see HitRobotEvent
	 * @see #getAllEvents()
	 */
