...
/**
 * The standard robot peer for standard robot types like {@link robotapi.Robot},
...
public interface IStandardRobotPeer extends IBasicRobotPeer {
	 ...
	 * turning its radar.
	 * <p/>
	 * Rescan will cause {@link IBasicEvents#onScannedRobot(robotapi.ScannedRobotEvent)
	 ...
	 *
	 * @see IBasicEvents#onScannedRobot(robotapi.ScannedRobotEvent)
	 *      onScannedRobot(ScannedRobotEvent)
	 * @see robotapi.ScannedRobotEvent
	 */
	void rescan();
