 ...
 *     - Javadocs
 *******************************************************************************/
package robotapi.robotinterfaces;
...
public interface IBasicEvents {
	 ...
	 * robot's heading by calling first calling {@link robotapi.Robot#getTime()} and then
	 * {@link robotapi.Robot#getHeading()} afterwards, as the time <em>might</em> change
	 * after between the {@link robotapi.Robot#getTime()} and {@link robotapi.Robot#getHeading()}
	 * call.
	 *
	 ...
	 * robotapi.Robot#fire(double) fire()} will fire directly at the robot.
	 * </ul>
	 * <p/>
