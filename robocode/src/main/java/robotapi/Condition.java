...
/**
 * Condition is used to define custom  {@link robotapi.AdvancedRobot#waitFor(Condition)}
 * and custom events for a {@link robotapi.AdvancedRobot}. The code below is taken from
 ...
 * @see robotapi.AdvancedRobot#waitFor(Condition)
 * @see robotapi.AdvancedRobot#addCustomEvent(Condition)
 * @see robotapi.AdvancedRobot#removeCustomEvent(Condition)
 * @see robotapi.AdvancedRobot#onCustomEvent(robotapi.CustomEvent)
 */
public abstract class Condition {
	 ...
	 * {@code true}. This is valid for both {@link robotapi.AdvancedRobot#waitFor} and
	 * {@link robotapi.AdvancedRobot#addCustomEvent}.
	 * <p/>
