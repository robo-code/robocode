	...
	public void componentShown(ComponentEvent e) {
		...
		if (selectedRobots != null && (/*robotPackager.isTeamPackager() ||*/ selectedRobots.size() == 1))
		{
			...
			if (filepath != null && filepath.indexOf(".") > 0)
			{
				...
				getWebpageHelpLabel().setText("(You may also leave this blank, and simply create the file: " + htmlfn + ")");
			}
			else
...
private void initialize() {
	...
	label = new JLabel("If you include the source, other people will be able to look at your code and learn from it.");
	label.setAlignmentX(JLabel.LEFT_ALIGNMENT);
	add(label);
...
private JLabel getVersionLabel()
{
	...
	{
		versionLabel = new JLabel("Please enter a version number for this robot (up to 10 chars, no spaces,commas,asterisks, or brackets).");
