...
import robocode.robotinterfaces.peer.ITeamRobotView;
 ...
 */
public class TeamRobotView extends AdvancedRobotView implements ITeamRobotView {
    private RobotMessageManager messageManager;

	public TeamRobotView(IRobotRobotPeer peer) {
		super(peer);
