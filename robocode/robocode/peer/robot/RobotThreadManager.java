...
public void forceStop() {
	...
	{
		robotPeer.getRobotStatistics().setNoScoring(true);
		robotPeer.out.println("SYSTEM:  You still have " + numThreads + " running threads.  No score will be generated.");
	}
	...
	public void waitForStop()
	{
		...
		if (runThreadGroup.activeCount() > 0)
		{
			if (!System.getProperty("NOSECURITY","false").equals("true"))
			{
				...
				log("Robot " + robotPeer.getName() + " has threads still running.  Not stopping them because security is off.");
		}
	}
	/**
	 * Gets the runThread.
