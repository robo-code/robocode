...
public interface IBattleRobotView extends IReadingRobotView {
    void lockWrite();
    void unlockWrite();
    void cleanup();
    ...
    void b_scan(java.util.List<IBattleRobotView> robots);
    void b_update(java.util.List<IBattleRobotView> battleRobots);

    void b_preInitialize();
    void b_initialize(double x, double y, double heading, java.util.List<IBattleRobotView> battleRobots);
