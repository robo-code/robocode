...
public synchronized void checkAccess(ThreadGroup g) {
	...
	if (cg.equals(g))
	{
		...
		if (g.activeCount() == 1)
		{
			//r.out.println("SYSTEM:  Warning:  Multithreaded robots are allowed,");
...
//		System.out.println("SecurityManager: Super returns not allowed for " + perm);
	}
