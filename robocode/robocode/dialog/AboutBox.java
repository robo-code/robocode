	...
	private javax.swing.JPanel getMainPanel() {
		if (mainPanel == null) {
			try {
				...
				p = new JPanel();
				String javaVersion = "You are using Java version " + System.getProperty("java.version") + " by "
	...
	private javax.swing.JTextArea getRobotBattleTextPane() {
		if (robotBattleTextPane == null) {
			try {
				...
				robotBattleTextPane.setText(
						"Inspired by Brad Schick\'s excellent game RobotBattle, at http://www.robotbattle.com");
