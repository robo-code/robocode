...
public Image getBulletImage() {
	if (bulletImage == null)
	{
		...
		try {
			bulletImage = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/resources/images/g1bullet.gif"));
  		} catch (Exception e) {
...
public Image getExplosionImage(int which, int frame, int size) {
	if (explodeImages == null)
	{
		...
		for (int i = 0; i < numExplosions; i++)
		{
			...
			{
				try {
					explodeImages[i][j][0] = Toolkit.getDefaultToolkit().getImage(getClass().getResource(getExplodeFilename(i,j)));
					...
					if (j == 0)
						explodeDimension[i] = new Dimension(explodeImages[i][j][0].getWidth(null),explodeImages[i][j][0].getHeight(null));
				} catch (Exception e) {
...
//			robotMaskImage = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/resources/images/g1body.colormask.gif"));
			robotMaskImage = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/resources/images/bodymask.gif"));
  		} catch (Exception e) {
...
//			gunMaskImage = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/resources/images/g1turret.colormask.gif"));
			gunMaskImage = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/resources/images/turretmask.gif"));
  		} catch (Exception e) {
...
//			radarMaskImage = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/resources/images/g1radar.colormask.gif"));
			radarMaskImage = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/resources/images/radarmask.gif"));
  		} catch (Exception e) {
...
public ImageArray getColoredRobotImageArray(int colorIndex) {
	...
	{
		coloredRobotImageArray[colorIndex] =
			ImageArray.createColoredImageArray(getRobotImageArray(),getRobotMaskImageArray(),getRobotColor(colorIndex),MASKCUTOFF,null);
	}
...
public ImageArray getColoredGunImageArray(int colorIndex) {
	...
	{
		coloredGunImageArray[colorIndex] =
			ImageArray.createColoredImageArray(getGunImageArray(),getGunMaskImageArray(),getGunColor(colorIndex),MASKCUTOFF,null);
	}
...
public ImageArray getColoredRadarImageArray(int colorIndex) {
	...
	{
		coloredRadarImageArray[colorIndex] =
			ImageArray.createColoredImageArray(getRadarImageArray(),getRadarMaskImageArray(),getRadarColor(colorIndex),MASKCUTOFF,null);
	}
...
public synchronized int getNewColorsIndex(Color robotColor, Color gunColor, Color radarColor) {
	if (nextColorIndex < maxColors)
	{
		...
		coloredRobotImageArray[nextColorIndex] = 
			ImageArray.createColoredImageArray(getRobotImageArray(),getRobotMaskImageArray(),robotColor,MASKCUTOFF,getRobotImageCache(nextColorIndex));

		coloredGunImageArray[nextColorIndex] = 
			ImageArray.createColoredImageArray(getGunImageArray(),getGunMaskImageArray(),gunColor,MASKCUTOFF,getGunImageCache(nextColorIndex));

		coloredRadarImageArray[nextColorIndex] = 
			ImageArray.createColoredImageArray(getRadarImageArray(),getRadarMaskImageArray(),radarColor,MASKCUTOFF,getRadarImageCache(nextColorIndex));
...
public synchronized int replaceColorsIndex(int colorIndex, Color robotColor, Color gunColor, Color radarColor) {
	...
	if (colorIndex < maxColors)
	{
		...
		coloredRobotImageArray[colorIndex] = 
			ImageArray.createColoredImageArray(getRobotImageArray(),getRobotMaskImageArray(),robotColor,MASKCUTOFF,getRobotImageCache(colorIndex));

		coloredGunImageArray[colorIndex] = 
			ImageArray.createColoredImageArray(getGunImageArray(),getGunMaskImageArray(),gunColor,MASKCUTOFF,getGunImageCache(colorIndex));

		coloredRadarImageArray[colorIndex] = 
			ImageArray.createColoredImageArray(getRadarImageArray(),getRadarMaskImageArray(),radarColor,MASKCUTOFF,getRadarImageCache(colorIndex));
