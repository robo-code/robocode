...
private javax.swing.JMenuItem getFileNewJavaFileMenuItem() {
	if (fileNewJavaFileMenuItem == null) {
		try {
			...
			fileNewJavaFileMenuItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N,java.awt.Event.CTRL_MASK | java.awt.Event.SHIFT_MASK));
...
private javax.swing.JMenuItem getFileNewRobotMenuItem() {
	if (fileNewRobotMenuItem == null) {
		try {
			...
			fileNewRobotMenuItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N,java.awt.Event.CTRL_MASK));
...
private javax.swing.JMenuItem getFileOpenMenuItem() {
	if (fileOpenMenuItem == null) {
		try {
			...
			fileOpenMenuItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O,java.awt.Event.CTRL_MASK));
...
private javax.swing.JMenuItem getFileSaveAsMenuItem() {
	if (fileSaveAsMenuItem == null) {
		try {
			...
			fileSaveAsMenuItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S,java.awt.Event.CTRL_MASK | java.awt.Event.SHIFT_MASK));
...
private javax.swing.JMenuItem getFileSaveMenuItem() {
	if (fileSaveMenuItem == null) {
		try {
			...
			fileSaveMenuItem.setAccelerator(KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S,java.awt.Event.CTRL_MASK));
