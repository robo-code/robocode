...
public void error(String msg) {
	Object[] options = { "OK" };
	JOptionPane.showOptionDialog(this, msg, "Error", 
		...
		try {
			...
			if (!a.equals(b))
			{
				int ok = JOptionPane.showConfirmDialog(this,
					...
					"Name has changed", JOptionPane.YES_NO_CANCEL_OPTION);
				if (ok == JOptionPane.CANCEL_OPTION)
					return false;
...
//	}
	...
	if (!f.exists())
	{
		int ok = JOptionPane.showConfirmDialog(this,
			...
			"Create Directory", JOptionPane.YES_NO_CANCEL_OPTION);
		if (ok == JOptionPane.YES_OPTION)
		{
			f.mkdirs();
			f = new File(saveDir);
...
public void success(String msg) {
	Object[] options = { "OK" };
	JOptionPane.showOptionDialog(this, msg, "Success", 
