...
import pimods.camera.CameraManager;
...
//			this.robot = new Robot( manager.getCanvas().getGraphicsConfiguration().getDevice() );
	...
	public void keyPressed( KeyEvent k ) {
		...
		try {
			...
			System.err.println( "Attenzione: tutto normale, pero` attento a quando generi gli eventi, sto ancora inizializzando! Capperi!" );
			cameraManager = null;
		}
	...
	public void mouseMoved( MouseEvent e ) {
		...
		if( this.motionEnabled ) {
			...
			if( cameraManager != null ) {
				cameraManager.tryToSetCameraDimension(
						this.manager.getCanvas().getSize().width,
