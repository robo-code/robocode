...
public class Transform3f {
	...
	public void pushMatrix() {
		...
		m.A=mM.A;m.B=mM.B;m.C=mM.C;m.D=mM.D;
		m.E=mM.E;m.F=mM.F;m.G=mM.G;m.H=mM.H;
		m.I=mM.I;m.L=mM.L;m.M=mM.M;m.N=mM.N;
		m.O=mM.O;m.P=mM.P;m.Q=mM.Q;m.R=mM.R;
	...
	public boolean popMatrix(){
		if( matrixStack.size() > 0 ){
			...
			mM.E=m.E;mM.F=m.F;mM.G=m.G;mM.H=m.H;
			mM.I=m.I;mM.L=m.L;mM.M=m.M;mM.N=m.N;
			mM.O=m.O;mM.P=m.P;mM.Q=m.Q;mM.R=m.R;
	...
	public void loadIdentity(){
		mM.A=1;mM.B=0;mM.C=0;mM.D=0;
		mM.E=0;mM.F=1;mM.G=0;mM.H=0;
		mM.I=0;mM.L=0;mM.M=1;mM.N=0;
		mM.O=0;mM.P=0;mM.Q=0;mM.R=1;
	}
	...
	public void rotateGeneral( float alpha, float x, float y, float z ){
		...
		t.mM.A=dir.getX();t.mM.B=A.getX();t.mM.C=B.getX();
		t.mM.E=dir.getY();t.mM.F=A.getY();t.mM.G=B.getY();
		t.mM.I=dir.getZ();t.mM.L=A.getZ();t.mM.M=B.getZ();
		
		mult( t );
		
		t.mM.A=dir.getX();t.mM.B=dir.getY();t.mM.C=dir.getZ();
	...
	public void mult( Transform3f t ) {
		...
		mM.A=A;mM.E=E;mM.I=I;mM.O=O;
		mM.B=B;mM.F=F;mM.L=L;mM.P=P;
		mM.C=C;mM.G=G;mM.M=M;mM.Q=Q;
		mM.D=D;mM.H=H;mM.N=N;mM.R=R;
	}
	...
	public static Transform3f GenerateProjectionToPlaneMatrix( Vertex3f f, Vertex3f pPos, Vertex3f pN ){
		...
		float k=(pN.getX()*(pPos.getX()-f.getX())+
