...
import pimods.controller.ControlListener;
...
public class MVCManager implements Runnable {
	 ...
	 */
	public MVCManager( MainFrame mFrame ){
		this.mFrame = mFrame;
	 ...
	 * @param animator
	 * @see GraphicListener#loadTextureFromModel(javax.media.opengl.GL, pimods.model.Model)
	 */
