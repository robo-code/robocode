...
import net.sf.robocode.host.proxies.BasicBotProxy;
...
public final class EventManager implements IEventManager {
	...
	private BasicBotProxy robotProxy;
	 ...
	 */
	public EventManager(BasicBotProxy robotProxy) {
	 ...
	 */
	public int getScannedRobotEventPriority2() {
