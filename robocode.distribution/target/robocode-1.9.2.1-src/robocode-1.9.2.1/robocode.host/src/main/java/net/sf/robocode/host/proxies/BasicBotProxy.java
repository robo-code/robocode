...
public abstract class BasicBotProxy  extends HostingRobotProxy implements IBasicRobotPeer {
	...
	public BasicBotProxy(IRobotItem specification, IHostManager hostManager,
			IRobotPeer peer, RobotStatics statics) {
