...
public class TestFileAttack extends RobotTestBed {
    ...
    public void onTurnEnded(TurnEndedEvent event) {
        ...
        if (out.contains("java.security.AccessControlException: Preventing testing.FileAttack from access: (java.io.FilePermission C:\\MSDOS.SYS read)")){
            messagedRead =true;
        }
        if (out.contains("java.security.AccessControlException: Preventing testing.FileAttack from access: (java.io.FilePermission C:\\Robocode.attack write)")){
            messagedWrite =true;
        }
    }
