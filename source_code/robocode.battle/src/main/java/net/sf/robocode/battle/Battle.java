 ...
 *	   Himanshu Singh
 *     - Modifications for Virtual Combat
 *******************************************************************************/
...
public final class Battle extends BaseBattle {
	...
	public void setup(RobotSpecification[] battlingRobotsList, BattleProperties battleProperties, 
		...
		if (customRules != null) {
			...
			System.out.println("This must never get printed.");
		}
	...
	protected int initializeBattle() {
		...
		int abort = customRules.startBattle(this);
	...
	{
		return customRules.isGameOver(getActiveRobots(), robots, robjects);
	}
	//Himanshu
	@Override
