...
public final class RobotSnapshot implements Serializable, IXmlSerializable, IRobotSnapshot {
	...
	private transient Area scanArc;
	
	private String scanArcSerialized;
	...
	public Area getScanArc() {
		//TODO uncomment to enable arc scan recording
		//@author mahesh
		
		/*XStream xstream=new XStream();
		if(scanArcSerialized!=null)
			scanArc=(Area) xstream.fromXML(scanArcSerialized);
		else
			return null;
	...
	private void serializeScanArc(){
		//TODO uncomment to enable arc scan recording
		//@author mahesh
		
		//XStream xstream=new XStream();
		//scanArcSerialized = xstream.toXML(scanArc);
