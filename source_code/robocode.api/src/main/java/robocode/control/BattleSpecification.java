...
public class BattleSpecification implements java.io.Serializable {
	 ...
	 */
	public BattleSpecification(int numRounds, BattlefieldSpecification battlefieldSize, RobotSpecification[] robots , String saveURL) {
		this(numRounds, 450, .1, battlefieldSize, robots , saveURL);
	}
	 ...
	 * @param robots		  the robots participating in this battle
	 */
	public BattleSpecification(int numRounds, long inactivityTime, double gunCoolingRate, BattlefieldSpecification battlefieldSize, RobotSpecification[] robots , String saveURL) {
