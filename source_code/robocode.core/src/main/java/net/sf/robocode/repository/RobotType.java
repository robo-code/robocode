...
public class RobotType implements Serializable {
	...
	transient public static final RobotType CTFRobot = new RobotType(128);	//added CTFRobot by Himanshu
	...
	public boolean isValid() {
		return isJuniorRobot() || isStandardRobot() || isAdvancedRobot() || isCTFRobot(); //hack by TeamCodefest
	}
	...
	public boolean isCTFRobot() {			//hack by Team Codefest
		return (code & CTFRobot.code) != 0;
	}
