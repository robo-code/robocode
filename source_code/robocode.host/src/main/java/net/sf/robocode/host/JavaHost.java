...
public class JavaHost implements IHost {
	...
	private RobotType checkInterfaces(Class<?> robotClass, IRobotRepositoryItem robotRepositoryItem) {
		...
		boolean isCTFRobot=false;
		
		
		//System.out.println("JavaHost, check INterfaces : CTFRobot");
		/*if (ICaptureTheFlagApi.class.isAssignableFrom(robotClass)) {
		...
		*/
		...
		//System.out.println(isJuniorRobot+" : "+ isStandardRobot+" : "+ isInteractiveRobot+" : "+ isPaintRobot+" : "+ isAdvancedRobot+" : "+isTeamRobot+" : "+ isDroid+" : "+isCTFRobot);
		return new RobotType(isJuniorRobot, isStandardRobot, isInteractiveRobot, isPaintRobot, isAdvancedRobot,isTeamRobot, isDroid, isCTFRobot);
	}
