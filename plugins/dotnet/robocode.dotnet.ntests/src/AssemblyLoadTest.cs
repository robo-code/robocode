...
namespace net.sf.robocode.dotnet
{
    ...
    public class AssemblyLoadTest
    {
        ...
        public void testJVM()
        {
            ...
            Bridge.LoadAndRegisterAssembly(@"D:\Sf\RobocodeN\plugins\dotnet\robocode.dotnet.ntests\target\robocode.dotnet.host-1.7.1.3.dll");
        }
        ...
        public void testDomain()
        {
            ...
            h.findItems(@"file:/D:/Sf/RobocodeN/plugins/dotnet/robocode.dotnet.samples/target/MyCsRobot.dll");
        }
    }
}
