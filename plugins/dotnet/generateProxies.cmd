...
if exist "%~dp0\robocode.dotnet.nhost\target\robocode.dotnet.nhost-1.7.4.0.dll" goto gen2
echo cat't find robocode.dotnet.nhost\target\robocode.dotnet.nhost-1.7.4.0.dll, please compile it
goto end
