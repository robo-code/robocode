...
:gen
rem "%~dp0\tools\lib\jni4net.proxygen-0.8.0.0.exe" tools\proxygen\robocode.control.proxygen.xml
rem "%~dp0\tools\lib\jni4net.proxygen-0.8.0.0.exe" tools\proxygen\robocode.proxygen.xml
...
:gen2
"%~dp0\tools\lib\jni4net.proxygen-0.8.0.0.exe" tools\proxygen\robocode.proxygen.net.xml
