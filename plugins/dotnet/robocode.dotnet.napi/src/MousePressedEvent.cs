...
namespace robocode
{
    public sealed class MousePressedEvent : MouseEvent
    {
        ...
        public MousePressedEvent(int id, long when, int modifiers, int x, int y, int clickCount, int button)
        ...
        internal sealed class SerializableHelper : ISerializableHelper
        {
            ...
            public object deserialize(RbSerializer serializer, ByteBuffer buffer1)
            {
                ...
                return
                    new MousePressedEvent(id, when, modifiers, x, y, clickCount, button);
            }

            public void serialize(RbSerializer serializer1, ByteBuffer buffer1, object obj1)
            {
                MouseEvent event3 = ((MousePressedEvent) obj1);
