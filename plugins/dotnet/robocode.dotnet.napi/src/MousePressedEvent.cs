...
namespace robocode
{
    public sealed class MousePressedEvent : MouseEvent
    {
        ...
        public MousePressedEvent(java.awt.@event.MouseEvent source) : base(source)
        {
        }
        ...
        internal override sealed void dispatch(IBasicRobot robot1, IRobotStatics statics1, Graphics2D graphics2D)
        {
            if (statics1.isInteractiveRobot())
            {
                ...
                if (events != null)
                {
                    events.onMousePressed(base.getSourceEvent());
                }
            }
        }
        ...
        [Modifiers(Modifiers.Synthetic | Modifiers.Synchronized), SourceFile("MousePressedEvent.java"),
         EnclosingMethod("robocode.MousePressedEvent", null, null),
        ...
        [Implements(new[] {"net.sf.robocode.serialization.ISerializableHelper"}), SourceFile("MousePressedEvent.java"),
        ...
        internal sealed class SerializableHelper : Object, ISerializableHelper
        {
            ...
            internal SerializableHelper(MousePressedEvent a1) : this()
            {
            }
            ...
            public object deserialize(RbSerializer serializer, ByteBuffer buffer1)
            {
                ...
                return
                    new MousePressedEvent(new java.awt.@event.MouseEvent(SafeComponent.getSafeEventComponent(), id, when,
            ...
            {
                java.awt.@event.MouseEvent event3 = ((MousePressedEvent) obj1).getSourceEvent();
            ...
            public int sizeOf(RbSerializer serializer, object onj)
            {
                return 0x21;
            }
