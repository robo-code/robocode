...
namespace robocode
{
    public sealed class MouseEnteredEvent : MouseEvent
    {
        ...
        public MouseEnteredEvent(java.awt.@event.MouseEvent source) : base(source)
        {
        }
        ...
        internal override sealed void dispatch(IBasicRobot robot1, IRobotStatics statics1, Graphics2D graphics2D)
        {
            if (statics1.isInteractiveRobot())
            {
                ...
                if (events != null)
                {
                    events.onMouseEntered(base.getSourceEvent());
                }
            }
        }
        ...
        [EnclosingMethod("robocode.MouseEnteredEvent", null, null),
         InnerClass(null, Modifiers.Synthetic | Modifiers.Static),
         Modifiers(Modifiers.Synthetic | Modifiers.Synchronized), SourceFile("MouseEnteredEvent.java")]
        ...
        [Implements(new[] {"net.sf.robocode.serialization.ISerializableHelper"}), SourceFile("MouseEnteredEvent.java"),
        ...
        internal sealed class SerializableHelper : Object, ISerializableHelper
        {
            ...
            public object deserialize(RbSerializer serializer, ByteBuffer buffer1)
            {
                ...
                return
                    new MouseEnteredEvent(new java.awt.@event.MouseEvent(SafeComponent.getSafeEventComponent(), id, when,
            ...
            {
                java.awt.@event.MouseEvent event3 = ((MouseEnteredEvent) obj1).getSourceEvent();
