...
namespace robocode
{
    public sealed class MouseClickedEvent : MouseEvent
    {
        ...
        public MouseClickedEvent(java.awt.@event.MouseEvent source) : base(source)
        {
        }
        ...
        internal override sealed void dispatch(IBasicRobot robot1, IRobotStatics statics1, Graphics2D graphics2D)
        {
            if (statics1.isInteractiveRobot())
            {
                ...
                if (events != null)
                {
                    events.onMouseClicked(base.getSourceEvent());
                }
            }
        }
        ...
        [InnerClass(null, Modifiers.Synthetic | Modifiers.Static),
         ...
         EnclosingMethod("robocode.MouseClickedEvent", null, null), SourceFile("MouseClickedEvent.java")]
        ...
        [InnerClass(null, Modifiers.Static | Modifiers.Private), SourceFile("MouseClickedEvent.java"),
        ...
        internal sealed class SerializableHelper : Object, ISerializableHelper
        {
            ...
            internal SerializableHelper(MouseClickedEvent a1) : this()
            {
            }
            ...
            public object deserialize(RbSerializer serializer, ByteBuffer buffer1)
            {
                ...
                return
                    new MouseClickedEvent(new java.awt.@event.MouseEvent(SafeComponent.getSafeEventComponent(), id, when,
            ...
            {
                java.awt.@event.MouseEvent event3 = ((MouseClickedEvent) obj1).getSourceEvent();
