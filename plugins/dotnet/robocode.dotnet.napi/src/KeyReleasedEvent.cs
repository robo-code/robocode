...
namespace robocode
{
    public sealed class KeyReleasedEvent : KeyEvent
    {
        ...
        public KeyReleasedEvent(java.awt.@event.KeyEvent source) : base(source)
        {
        }
        ...
        internal override sealed void dispatch(IBasicRobot robot1, IRobotStatics statics1, Graphics2D kGraphics2D)
        {
            if (statics1.isInteractiveRobot())
            {
                ...
                if (events != null)
                {
                    events.onKeyReleased(base.getSourceEvent());
                }
            }
        }
        ...
        [InnerClass(null, Modifiers.Synthetic | Modifiers.Static),
         EnclosingMethod("robocode.KeyReleasedEvent", null, null),
         Modifiers(Modifiers.Synthetic | Modifiers.Synchronized), SourceFile("KeyReleasedEvent.java")]
        ...
        [SourceFile("KeyReleasedEvent.java"), InnerClass(null, Modifiers.Static | Modifiers.Private),
        ...
        internal sealed class SerializableHelper : Object, ISerializableHelper
        {
            ...
            public object deserialize(RbSerializer serializer, ByteBuffer buffer1)
            {
                ...
                return
                    new KeyReleasedEvent(new java.awt.@event.KeyEvent(SafeComponent.getSafeEventComponent(), id, when,
            ...
            {
                java.awt.@event.KeyEvent event3 = ((KeyReleasedEvent) obj1).getSourceEvent();
