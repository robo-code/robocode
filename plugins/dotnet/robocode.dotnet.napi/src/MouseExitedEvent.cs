...
namespace robocode
{
    public sealed class MouseExitedEvent : MouseEvent
    {
        ...
        public MouseExitedEvent(java.awt.@event.MouseEvent source) : base(source)
        {
        }
        ...
        internal override sealed void dispatch(IBasicRobot robot1, IRobotStatics statics1, Graphics2D graphics2D)
        {
            if (statics1.isInteractiveRobot())
            {
                ...
                if (events != null)
                {
                    events.onMouseExited(base.getSourceEvent());
                }
            }
        }
        ...
        [Modifiers(Modifiers.Synthetic | Modifiers.Synchronized), SourceFile("MouseExitedEvent.java"),
         InnerClass(null, Modifiers.Synthetic | Modifiers.Static),
         EnclosingMethod("robocode.MouseExitedEvent", null, null)]
        ...
        [InnerClass(null, Modifiers.Static | Modifiers.Private), SourceFile("MouseExitedEvent.java"),
        ...
        internal sealed class SerializableHelper : Object, ISerializableHelper
        {
            ...
            public object deserialize(RbSerializer serializer, ByteBuffer buffer1)
            {
                ...
                return
                    new MouseExitedEvent(new java.awt.@event.MouseEvent(SafeComponent.getSafeEventComponent(), id, when,
            ...
            {
                java.awt.@event.MouseEvent event3 = ((MouseExitedEvent) obj1).getSourceEvent();
