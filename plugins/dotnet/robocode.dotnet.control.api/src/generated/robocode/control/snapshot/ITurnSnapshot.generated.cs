...
namespace robocode.control.snapshot {
    ...
    internal sealed partial class @__ITurnSnapshot : global::java.lang.Object, global::robocode.control.snapshot.ITurnSnapshot {
        ...
        internal static global::net.sf.jni4net.jni.MethodId _getRobots0;
        
        internal static global::net.sf.jni4net.jni.MethodId _getBullets1;
        
        internal static global::net.sf.jni4net.jni.MethodId _getTPS2;
        
        internal static global::net.sf.jni4net.jni.MethodId _getRound3;
        
        internal static global::net.sf.jni4net.jni.MethodId _getTurn4;
        
        internal static global::net.sf.jni4net.jni.MethodId _getSortedTeamScores5;
        
        internal static global::net.sf.jni4net.jni.MethodId _getIndexedTeamScores6;
        ...
        private static void InitJNI(global::net.sf.jni4net.jni.JNIEnv @__env, java.lang.Class @__class) {
            ...
            global::robocode.control.snapshot.@__ITurnSnapshot._getRobots0 = @__env.GetMethodID(global::robocode.control.snapshot.@__ITurnSnapshot.staticClass, "getRobots", "()[Lrobocode/control/snapshot/IRobotSnapshot;");
            global::robocode.control.snapshot.@__ITurnSnapshot._getBullets1 = @__env.GetMethodID(global::robocode.control.snapshot.@__ITurnSnapshot.staticClass, "getBullets", "()[Lrobocode/control/snapshot/IBulletSnapshot;");
            global::robocode.control.snapshot.@__ITurnSnapshot._getTPS2 = @__env.GetMethodID(global::robocode.control.snapshot.@__ITurnSnapshot.staticClass, "getTPS", "()I");
            global::robocode.control.snapshot.@__ITurnSnapshot._getRound3 = @__env.GetMethodID(global::robocode.control.snapshot.@__ITurnSnapshot.staticClass, "getRound", "()I");
            global::robocode.control.snapshot.@__ITurnSnapshot._getTurn4 = @__env.GetMethodID(global::robocode.control.snapshot.@__ITurnSnapshot.staticClass, "getTurn", "()I");
            global::robocode.control.snapshot.@__ITurnSnapshot._getSortedTeamScores5 = @__env.GetMethodID(global::robocode.control.snapshot.@__ITurnSnapshot.staticClass, "getSortedTeamScores", "()[Lrobocode/control/snapshot/IScoreSnapshot;");
            global::robocode.control.snapshot.@__ITurnSnapshot._getIndexedTeamScores6 = @__env.GetMethodID(global::robocode.control.snapshot.@__ITurnSnapshot.staticClass, "getIndexedTeamScores", "()[Lrobocode/control/snapshot/IScoreSnapshot;");
        }
        
        public robocode.control.snapshot.IRobotSnapshot[] getRobots() {
            global::net.sf.jni4net.jni.JNIEnv @__env = this.Env;
            return global::net.sf.jni4net.utils.Convertor.ArrayFullJ2C<robocode.control.snapshot.IRobotSnapshot[], global::robocode.control.snapshot.IRobotSnapshot>(@__env, @__env.CallObjectMethodPtr(this, global::robocode.control.snapshot.@__ITurnSnapshot._getRobots0));
        }
        
        public robocode.control.snapshot.IBulletSnapshot[] getBullets() {
            global::net.sf.jni4net.jni.JNIEnv @__env = this.Env;
            return global::net.sf.jni4net.utils.Convertor.ArrayFullJ2C<robocode.control.snapshot.IBulletSnapshot[], global::robocode.control.snapshot.IBulletSnapshot>(@__env, @__env.CallObjectMethodPtr(this, global::robocode.control.snapshot.@__ITurnSnapshot._getBullets1));
        }
        
        public int getTPS() {
            global::net.sf.jni4net.jni.JNIEnv @__env = this.Env;
            return ((int)(@__env.CallIntMethod(this, global::robocode.control.snapshot.@__ITurnSnapshot._getTPS2)));
        }
        
        public int getRound() {
            global::net.sf.jni4net.jni.JNIEnv @__env = this.Env;
            return ((int)(@__env.CallIntMethod(this, global::robocode.control.snapshot.@__ITurnSnapshot._getRound3)));
        }
        
        public int getTurn() {
            global::net.sf.jni4net.jni.JNIEnv @__env = this.Env;
            return ((int)(@__env.CallIntMethod(this, global::robocode.control.snapshot.@__ITurnSnapshot._getTurn4)));
        }
        
        public robocode.control.snapshot.IScoreSnapshot[] getSortedTeamScores() {
            global::net.sf.jni4net.jni.JNIEnv @__env = this.Env;
            return global::net.sf.jni4net.utils.Convertor.ArrayFullJ2C<robocode.control.snapshot.IScoreSnapshot[], global::robocode.control.snapshot.IScoreSnapshot>(@__env, @__env.CallObjectMethodPtr(this, global::robocode.control.snapshot.@__ITurnSnapshot._getSortedTeamScores5));
        }
        
        public robocode.control.snapshot.IScoreSnapshot[] getIndexedTeamScores() {
            global::net.sf.jni4net.jni.JNIEnv @__env = this.Env;
            return global::net.sf.jni4net.utils.Convertor.ArrayFullJ2C<robocode.control.snapshot.IScoreSnapshot[], global::robocode.control.snapshot.IScoreSnapshot>(@__env, @__env.CallObjectMethodPtr(this, global::robocode.control.snapshot.@__ITurnSnapshot._getIndexedTeamScores6));
        }
