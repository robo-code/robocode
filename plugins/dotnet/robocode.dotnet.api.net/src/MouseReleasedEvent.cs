...
namespace robocode
{
    public sealed class MouseReleasedEvent : MouseEvent
    {
        ...
        public MouseReleasedEvent(int id, long when, int modifiers, int x, int y, int clickCount, int button)
        ...
        internal sealed class SerializableHelper : ISerializableHelper
        {
            ...
            public object deserialize(RbSerializer ser, BinaryReader br)
            {
                ...
                return
                    new MouseReleasedEvent(id, when, modifiers, x, y, clickCount, button);
            }

            public void serialize(RbSerializer serializer, BinaryWriter bw, object obj)
            {
                MouseEvent event3 = ((MouseReleasedEvent) obj);
