...
namespace robocode.dotnet.nhost.jni
{
    public static unsafe class JNI
    {
        ...
        private static class Dll
        {
            ...
            public static extern JNIResult JNI_CreateJavaVM(out JavaVM.Real* pvm, out JNIEnv.Real* penv, ref JavaVMInitArgs args);
        ...
        public static JNIResult JNI_CreateJavaVM(out JavaVM pvm, out JNIEnv penv)
        {
            ...
            JNIResult result = Dll.JNI_CreateJavaVM(out vm, out env, ref JavaVM.vm_args);
