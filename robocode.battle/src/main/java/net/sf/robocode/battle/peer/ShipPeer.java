...
//	
	...
	protected void updateGunHeat() {
		...
		for (MineComponent mine: mines) {
			mine.rechargeMine(battleRules.getGunCoolingRate()*0.5);
		}
	...
	protected void fireBullets(List<BulletCommand> bulletCommands) {
		...
		BulletCommandShip bCommand;
			...
			newBullet = new BulletPeer(this, battleRules, bulletCmd.getBulletId(), weaponComponent.getBulletColor().getRGB());
